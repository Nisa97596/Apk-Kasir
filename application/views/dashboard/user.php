                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($users as $user): ?>
                                                <tr>
                                                    ...
                                                    <td><?= $user['username'] ?></td>
                                                    <td style="width: 10rem;"><?= $user['password'] ?></td>
                                                    <td><?= $user['no_hp'] ?></td>
                                                    <td><?= $user['alamat'] ?></td>
                                                    <td><?= $user['role'] ?></td>
                                                    <td><?= $user['status'] ?></td>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a class="btn btn-danger shadow btn-xs sharp"
                                                                onclick="deleteConfirm(<?= $user['id_user'] ?>)"><i
                                                                    class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                ...
                                <div class="modal fade" id="editUser<?= $user['id_user'] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="tambahDataForm" method="post"
                                                    action="<?= base_url('Edit_user/') . $user['id_user'] ?>">
                                                    <!-- Input Nama -->
                                                    <div class="mb-3">
                                                        <label for="nama" class="form-label">Nama</label>
                                                        <input type="text" class="form-control" id="nama" name="nama"
                                                            value="<?= $user['nama_user'] ?>" placeholder="Masukkan nama"
                                                            required>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="no_hp" class="form-label">No. HP</label>
                                                        <input type="text" class="form-control" id="no_hp" name="no_hp"
                                                            value="<?= $user['no_hp'] ?>" placeholder="Masukkan no. HP"
                                                            required>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="status" name="status" required>
                                                            ...
                                                            <option value="tidak aktif" <?= $user['status'] == 'tidak aktif' ? 'selected' : '' ?>>Non-aktif</option>
                                                        </select>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Batal</button>
                                                        <button type="sudmit" class="btn btn-primary" id="simpanDataBtn"
        ...
        function deleteConfirm(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?= base_url('Delete_user/') ?>" + id;
                }
            });
        }
    </script>
