                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="" data-bs-toggle="modal"
                                                                data-bs-target="#editKategori<?= $data['id_kategori'] ?>"
                                                                class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                                    class="fas fa-pencil-alt"></i></a>
                                                            <a class="btn btn-danger shadow btn-xs sharp"
                                                                onclick="deleteConfirm(<?= $data['id_kategori'] ?>)"><i
                                                                    class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                            ...
                            <?php foreach ($datas as $data): ?>
                                <!-- Edit Form -->
                                <div class="modal fade" id="editKategori<?= $data['id_kategori'] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="tambahDataForm" method="post"
                                                    action="<?= base_url('Edit_kategori/') . $data['id_kategori'] ?>">
                                                    <!-- Input Nama -->
                                                    <div class="mb-3">
                                                        <label for="nama" class="form-label">Kategori</label>
                                                        <input type="text" class="form-control" id="nama" name="nama"
